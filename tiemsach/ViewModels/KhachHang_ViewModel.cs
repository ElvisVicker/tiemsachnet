...
namespace tiemsach.ViewModels
{
    public class KhachHang_ViewModel
    {
        ...
        [Required] public IEnumerable<Diachi> diachis { get; set; }
        ...
        public KhachHang_ViewModel(Nguoidung user, IEnumerable<Diachi> diachis, DateTime? created_at, DateTime? updated_at)
        {
            id = user.Id;
            hoten = user.Hoten;
            email = user.Email;
